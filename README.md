...
MVP do curso de Engenharia de Dados que faz parte da pós graduação de Ciência de Dados e Analytics da PUC-Rio
...
## Coleta de Dados
A SEC disponibiliza os dados das empresas americanas listadas em bolsa no EDGAR (Electronic Data Gathering, Analysis, and Retrieval). 
